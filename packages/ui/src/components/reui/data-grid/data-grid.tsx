// NOTE: TanStack Table relies on mutable instance state that the React
// Compiler's memoization freezes (rows stop updating on sort/pagination).
// Consuming apps must exclude this `reui/` folder from the compiler — see
...
function DataGridProvider<TData extends object>({
  ...
  // The context value below is memoized on table-state slices read via
  // table.getState(); the React Compiler can't track those and would key the
  // memo on the stable `table` ref, freezing consumers. Opt this out.
  "use no memo";
