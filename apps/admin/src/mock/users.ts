...
export const mockUsers: AdminUser[] = [
  { id: "u1", name: "Lý Gia Hân", email: "giahan@example.com", avatar: av("giahan-av"), role: "photographer", status: "active", city: "Hà Nội", joinedAt: daysAgo(210), bookingsCount: 96 },
  { id: "u2", name: "Nguyễn Minh Anh", email: "minhanh@example.com", avatar: av("minhanh-av"), role: "photographer", status: "active", city: "Hà Nội", joinedAt: daysAgo(420), bookingsCount: 128 },
  { id: "u3", name: "Trần Quốc Bảo", email: "quocbao@example.com", avatar: av("quocbao-av"), role: "photographer", status: "active", city: "TP. Hồ Chí Minh", joinedAt: daysAgo(610), bookingsCount: 214 },
  ...
  { id: "u9", name: "Lê Thị Hương", email: "lehuong@example.com", avatar: av("lehuong-av"), role: "photographer", status: "active", city: "Đà Nẵng", joinedAt: daysAgo(300), bookingsCount: 86 },
  ...
  { id: "u11", name: "Phạm Đức Duy", email: "ducduy@example.com", avatar: av("ducduy-av"), role: "photographer", status: "suspended", city: "Hà Nội", joinedAt: daysAgo(260), bookingsCount: 64 },
  { id: "u12", name: "Bùi Thanh Thảo", email: "thanhthao@example.com", avatar: av("thanhthao-av"), role: "photographer", status: "active", city: "Đà Lạt", joinedAt: daysAgo(540), bookingsCount: 173 },
];
